;; Reto 4.3: Choque por la izquierda
...
leer_teclas:
  ...
  mover_izquierda:
    ...
    ;;-- Hay que comprobar en que posicion estamos
    ld hl, (pos_vagoneta_video)
    ld a,l
    cp #10  ;;-- Vagoneta en la posicion inicial?
    jr nz, mover_izquierda_ok

    ;;-- Estamos colisionando con la parez izquierda!!
    call animacion_choque
...
;;
;; ENTRADA:
;;   A: Incremento a aplicar:  1 (derecha). -1 (izquierda)
;;
;; MODIFICA:
;;   HL, B, A
;;========================================
...
;;-------------------------------------------------------------
;; Dibujar Vagoneta rota en posicion dada en HL
;; 
;; ENTRADAS:
